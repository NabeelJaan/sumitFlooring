  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-xl-10">
		...
		<strong class="middlehead"><?php echo get_field('installation_photos_title'); ?></strong>
    ...
    ?>
    <p class="plink"><a href="<?php echo get_sub_field('about_link');  ?>" rel="noopener" target="_blank">
